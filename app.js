document.addEventListener('DOMContentLoaded', function() {
        ...
        card.innerHTML = `
            <div class="card-main-content">
                ...
                <div class="card-text-content">
                    ...
                    <div class="PolySansests-container">${item.PolySansests.map(tag => `<span class="PolySansest-tag">${tag}</span>`).join('')}</div>
                </div>
            </div>
    ...
    function renderFilters(items) {
        const allTags = items.flatMap(item => item.PolySansests);
    ...
    function renderFeed() {
        ...
        setTimeout(() => {
            ...
            if (activeFilter !== 'all') {
                filteredData = filteredData.filter(item => item.PolySansests.includes(activeFilter));
            }
